...
<img src="img/download.PNG" style="width: 60%;" alt="tela-Principal">
...
<img src="img/caminhoarquivos.PNG" style="width: 60%;" alt="tela-Principal">
...
<img src="img/composer.PNG" style="width: 60%;" alt="tela-Principal">

altere o nome do seu .env.example para .env
<img src="img/env.PNG" style="width: 60%;" alt="tela-Principal">

Para garantir que o programa rode normalmente rode o comando **php artisan key:generate** no cmd na pasta
<img src="img/key.PNG" style="width: 60%;" alt="tela-Principal">

use o comamdo php artisan serve 
<img src="img/servidor.PNG" style="width: 60%;" alt="tela-Principal">

endereço http://localhost:8000/ no seu navegador.
<img src="img/telaInicial.PNG" style="width: 60%;" alt="tela-Principal">

No projeto foi adicionado um formulario onde pode se colocar Altura e Largura 
<img src="img/formulario.PNG" style="width: 60%;" alt="tela-Principal">

Também foi validado se os campos estao sendo passados vazios 
<img src="img/DadosVazios.PNG" style="width: 60%;" alt="tela-Principal">

A resposta virá como uma modal na tela 
<img src="img/usoModal.PNG" style="width: 60%;" alt="tela-Principal">